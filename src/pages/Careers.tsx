...
const Careers = () => {
  ...
  const filteredJobs = jobOpenings.filter(job => {
    ...
    const matchesSearch = job.title.toLowerCase().includes(searchTerm.toLowerCase()) || job.description.toLowerCase().includes(searchTerm.toLowerCase()) || job.location.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
          <CareerHero searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
