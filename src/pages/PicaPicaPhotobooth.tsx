...
import StripFrameSelector from '@/components/StripFrameSelector';
...
const PicaPicaPhotobooth = () => {
  ...
  const handleDownloadStrip = async () => {
    ...
    try {
      toast.loading('Creating your high-quality photo strip...');
      
      // Use the improved download utility for higher quality output
      await downloadLayoutImage(photoStripRef, 'photostrip', bgColor);
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-grow lg:w-[70%] bg-white rounded-xl shadow-lg p-4 overflow-hidden">
              <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden shadow-inner">
                <WebcamCapture onCapture={handlePhotoCaptured} isCapturing={isCapturing} overlayImage={overlayImageRef.current} />
              </div>
              
              <PhotoBoothControls onTakePhoto={handleTakePhoto} onRetakePhoto={handleRetakePhoto} isCapturing={isCapturing} hasPhotos={capturedPhotos.length > 0} />
            </div>
            ...
            <div className="lg:w-[30%] bg-white rounded-xl shadow-lg p-4">
              ...
              <StripFrameSelector selectedFrame={frameColor} onSelectFrame={handleFrameColorChange} />
