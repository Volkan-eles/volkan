  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-center space-x-2">
        <Button 
          className={`rounded-full px-4 py-1 text-sm ${frameColor === 'white' ? 'bg-white text-black' : 'bg-gray-200 text-black'}`}
          onClick={() => onFrameColorChange('white')}
        >
          White
        </Button>
        <Button 
          className={`rounded-full px-4 py-1 text-sm ${frameColor === 'green' ? 'bg-green-500 text-white' : 'bg-green-500/80 text-white'}`}
          onClick={() => onFrameColorChange('green')}
        >
          Green
        </Button>
        <Button 
          className="rounded-full px-4 py-1 text-sm bg-red-500 text-white"
        >
          More
        </Button>
      </div>
      ...
      <div className={`flex-1 bg-[#4b30ab] p-2 rounded-lg overflow-hidden`}>
        <div className="h-[280px] md:h-[320px] rounded-lg overflow-hidden bg-white">
          <WebcamCapture 
      ...
      {/* Camera Buttons */}
      <div className="flex justify-center space-x-4 bg-[#4b30ab] py-2 rounded-lg">
        <Button 
          variant="ghost" 
        ...
        <Button 
          variant="ghost" 
          className="text-white h-10 w-10 rounded-full border-2 border-white flex items-center justify-center"
