...
const DigiboothHeroArea: React.FC = () => {
  return <section className="bg-gradient-to-r from-blue-600 to-teal-500 text-white py-12 md:py-20">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Digibooth Photobooth | Digibooth by @dev.dietherdave
      </h1>
