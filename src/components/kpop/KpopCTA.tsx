      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Join thousands of K-pop fans who are creating and sharing amazing photo strips with our digital photobooth
          </p>
          ...
          <div className="mt-8 text-white/80 flex items-center justify-center gap-1">
            ...
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <span className="ml-2">Rated 5.0 by K-pop fans worldwide</span>
          </div>
        </div>
      </div>
    </section>
