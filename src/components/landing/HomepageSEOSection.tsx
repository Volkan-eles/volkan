  ...
  return (
    <section className="bg-gray-50 py-12 md:py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">KPop Photobooth | Create Virtual Photos with K-pop Idols</h2>
        
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 mb-4 leading-relaxed">
            Welcome to KPop Photobooth, your ultimate digital photo experience combining cutting-edge technology with creative personalization. Our innovative platform transforms ordinary moments into extraordinary memories through customizable frames, filters, and interactive features. Whether you're celebrating special occasions or just having fun with friends, KPop Photobooth delivers professional-quality photos with the perfect blend of sophistication and playfulness that will keep your memories vibrant for years to come.
          </p>
          
          <div id="ad-container-homepage" className="my-8 p-4 bg-gray-50 border border-gray-200 rounded-md text-center">
          ...
          >
            <CollapsibleTrigger asChild>
              ...
              >
                <span>{isOpen ? "Read less" : "Read more about KPop Photobooth"}</span>
